...
// A window object [object Window] Window {window: Window, self: Window, document: document, name: '', location: Location, …}
//
// 2. What is "this" when joe.scopeArrow() is invoked?
//  undefined according to my console
//
// 3. Explain why "this" is different when an arrow function is used.
// Honestly I am not sure, this was first a student object and then became an object called window so I'll have to figure out what is going on because I'm not sure why it did that. 
